...
class EditInvoicePreviewPage extends StatefulWidget {
  const EditInvoicePreviewPage({super.key});

  @override
  State<EditInvoicePreviewPage> createState() => _EditInvoicePreviewPageState();
}

class _EditInvoicePreviewPageState extends State<EditInvoicePreviewPage> {
  late InvoiceController invoiceController;

  @override
  void initState() {
    invoiceController = context.read<EditInvoiceBloc>().invoiceController!;
    super.initState();
  }
