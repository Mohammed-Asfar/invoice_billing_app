...
class _QuotationPreviewPageState extends State<QuotationPreviewPage> {
  late QuotationController quotationController;
  ...
  Widget _buildQuotationDetails() {
    return Column(
      ...
      children: [
        InvoiceDetailTile(
            title: "Quotation No",
            value: quotationController.quotationNoController.text),
        SizedBox(
          height: 5,
        ),
        InvoiceDetailTile(
            title: "Quotation Date",
            value: dateFormat(quotationController.issuedDateController)),
        SizedBox(
          height: 5,
        ),
        InvoiceDetailTile(
            title: "Valid Until",
            value: dateFormat(quotationController.validUntilDateController)),
      ],
    );
  }
  ...
  Widget _billedDetails({required User user}) {
    return Column(
      ...
      children: [
        ...
        InvoiceDetailTile(
          title: "Name",
          value: quotationController.customerNameController.text,
        ),
        InvoiceDetailTile(
          title: "Address",
          value: quotationController.customerAddressController.text,
        ),
        InvoiceDetailTile(
          title: "Phone",
          value: quotationController.customerPhoneController.text,
        ),
        InvoiceDetailTile(
          title: "State Name",
          value: quotationController.customerStateNameController.text,
        ),
        InvoiceDetailTile(
          title: "Code",
          value: quotationController.customerCodeController.text,
        ),
        SizedBox(
          height: 20,
        ),
        ...
        InvoiceDetailTile(
          title: "Name",
          value: quotationController.shippingNameController.text,
        ),
        InvoiceDetailTile(
          title: "Address",
          value: quotationController.shippingAddressController.text,
        ),
        InvoiceDetailTile(
          title: "State Name",
          value: quotationController.shippingStateController.text,
        ),
        InvoiceDetailTile(
          title: "Code",
          value: quotationController.shippingCodeController.text,
        ),
      ],
    );
  }
      ...
      children: [
        ...
        Table(
          ...
          children: [
            ...
            ...quotationController.productControllers.map(
              (product) => TableRow(
                children: [
                  Padding(
                      padding: EdgeInsets.all(8),
    ...
    return Column(
      ...
      children: [
        ...
        InvoiceDetailTile(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            title: "Round Off",
            value: "₹ ${quotationController.roundOffController.text}"),
        Divider(),
        InvoiceDetailTile(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            title: "Grand Total",
            value: "₹ ${quotationController.grandTotalController.text}"),
        InvoiceDetailTile(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            title: "In Words",
            value: quotationController.grandTotalInWordsController.text),
      ],
    );
  }
}